...
namespace CarManagetment.Controllers
{
    ...
    public class ServiceController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateService([FromBody] DTOs.ServiceDTO serviceDto)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> UpdateService(int id, [FromBody] DTOs.ServiceDTO serviceDto)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
