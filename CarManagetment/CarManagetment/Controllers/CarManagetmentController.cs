...
namespace CarManagetment.Controllers
{
    ...
    public class CarMangetmentController : ControllerBase
    {
        ...
        public ActionResult<CarDTO> CreateCar(CarDTO carDTO)
        {
            ...
            //if (HttpContext.Items["CustomerId"] == null)
            //    return Unauthorized("Unauthorized: CustomerId missing in token.");


            int customerId = int.Parse(HttpContext.Items["CustomerId"].ToString());
